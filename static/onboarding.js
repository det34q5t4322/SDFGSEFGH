...
(function() {
  ...
  const STEPS = [
    ...
    },
    {
      id: 'calendar',
      title: '📅 Дни и недели',
      body: 'Переключайтесь между днями недели (Пн–Сб) в один клик. Стрелками <b>◀ ▶</b> можно листать недели вперёд и назад. Текущий день и числитель/знаменатель определяются автоматически!',
    ...
    {
      id: 'themes',
      title: '🎨 Темы и минимальный режим',
      body: 'Нажмите на палитру, чтобы выбрать цветовую тему по вкусу (тёмные, светлые, киберпанк), настроить размер шрифта или включить <b>«Минимальный режим»</b> без лишних рамок и теней.',
      getTarget: () => document.getElementById('topbarThemeBtn'),
      preferredPosition: 'bottom'
    },
    {
      id: 'constructor',
      title: '🛠 Конструктор интерфейса',
      body: 'Настройте интерфейс под себя! В меню (кнопка ☰) выберите <b>«Конструктор»</b>: можно менять порядок блоков на экране (перетаскиванием за иконку ⠿), скрывать ненужные виджеты и настраивать карточки пар.',
